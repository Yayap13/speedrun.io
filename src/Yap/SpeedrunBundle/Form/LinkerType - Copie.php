...
class LinkerType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('game', 'entity', array('class' => 'YapSpeedrunBundle:Game', 'property' => 'name'))
            ->add('category', 'entity', array('class' => 'YapSpeedrunBundle:Category', 'property' => 'name', 'multiple' => false, 'expanded' => true))
            ->add('difficulty', 'entity', array('class' => 'YapSpeedrunBundle:Difficulty', 'property' => 'name'))
        ;

        $refreshDifficulty = function ($form, $game) use ($factory) {
            $form->add($factory->createNamed('difficulty', 'entity', null, array(
